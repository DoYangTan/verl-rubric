...
EXP_NAME="GSM8K_GRPO_1"
PROJECT_NAME="Qwen2.5-0.5B-Instruct"
...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=hdfs://harunawl/home/byte_data_seed_wl/user/zhouyang.1107/data/gsm8k/train.parquet \
    data.val_files=hdfs://harunawl/home/byte_data_seed_wl/user/zhouyang.1107/data/gsm8k/test.parquet \
    data.train_batch_size=${train_batch_size} \
    data.max_prompt_length=${max_prompt_length} \
    data.max_response_length=${max_response_length} \
    data.filter_overlong_prompts=True \
    data.truncation='error' \
    actor_rollout_ref.model.path=hdfs://haruna/home/byte_data_seed/ssd_hldy/user/zhouyang.1107/models/Qwen2.5-0.5B-Instruct \
